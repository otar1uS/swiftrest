...
import { HomePageTextsEn, HomePageTextsKa } from "../texts";
            ...
            <div className="max-w-[1600px] mx-auto py-8 px-4 sm:px-6 lg:px-8">
              <div className="flex flex-col sm:flex-row items-center justify-around">
                <div className="w-full  sm:w-2/3 flex items-start justify-around flex-col">
                  {(locale == "en" ? HomePageTextsEn : HomePageTextsKa).map(
                    (t) => {
                      return (
                        <Link
                          className="relative w-full py-4 sm:w-4/5 h-auto parent-div overflow-hidden text-white hover:text-black cursor-pointer text-5xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold leading-[0.8] duration-1000 transition-all hover:scale-105"
                          key={t.id}
                          to={t.text}
                          smooth={true}
                          duration={1000}
