...
const Contact = () => {
  ...
  return (
    <div className="w-full h-screen relative bg-slate-950   " id="CONTACT">
      ...
      >
        <Section name={locale == "en" ? "Contact Us" : "დაგვიკავშირდით"} />
      </motion.h1>

      <div className=" z-[100] left-[50%]  -translate-x-[50%] absolute  min-w-[400px] lg:min-w-[1200px]  flex-col  mt-[10rem] lg:flex-row   h-screen flex justify-between items-center  ">
        <Globe />
        <ContactForm />
      </div>
    </div>
